"""Econometric research: common walk-forward interface and exact replay."""
...
def main() -> None:
    ...
    modes.add_argument('--suite',type=Path); modes.add_argument('--input',type=Path); modes.add_argument('--replay',type=Path)
    parser.add_argument('--kind',choices=('forecast','proposal','evaluation'),default='evaluation'); parser.add_argument('--output',type=Path)
